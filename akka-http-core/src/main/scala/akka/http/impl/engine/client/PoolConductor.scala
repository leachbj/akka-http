...
private object PoolConductor {
  ...
  */
  ...
  private class SlotSelector(slotSettings: PoolSlotsSetting, pipeliningLimit: Int, log: LoggingAdapter)
    ...
    private val requestContextsIn = Inlet[RequestContext]("requestContextsIn")
    private val slotEventsIn = Inlet[SlotEvent]("slotEventsIn")
    private val slotCommandsOut = Outlet[SwitchSlotCommand]("slotCommandsOut")
